...
- Fixed several back-to-back acts (including Danger & Beyond) whose members did not open a bio page; both halves now link out correctly.
...
- Improved several artist bios with more detail from their own SoundCloud pages.
...
- Fixed 12 collab acts (e.g. "Danger & Beyond", "Raja Ram & Lucas") that were showing as one plain block of text instead of separate, tappable artist entries.
...
- Browse the full OZORA lineup across every stage and day — as a grid, a list, or stage rows.
- Tap any artist for their bio, photo, genres, and links.
- Festival site map — pinch-to-zoom to find your way around.
